...
var re = regexp.MustCompile(`(\d+) (red|green|blue)`)

func main() {
	fmt.Println(possibleGames(part1)) // 8
	fmt.Println(possibleGames(input)) // 2162
	fmt.Println(powerCube(part2))     // 2286
	fmt.Println(powerCube(input))     // 72513
}

func possibleGames(n string) (result int) {
	// 12 red cubes, 13 green cubes, and 14 blue cubes
	cubesByColor := map[string]int{
		"red":   12,
		"green": 13,
		"blue":  14,
	}
	...
	for i, line := range lines {
		...
		for _, match := range matches {
			str, color, ok := strings.Cut(match, " ")
			if !ok {
				panic("invalid input")
			}
...
func powerCube(n string) int {
	var result int

	lines := strings.Split(n, "\n")
	for _, line := range lines {
		matches := re.FindAllString(line, -1)
		colorByCount := make(map[string]int)
		for _, match := range matches {
			ns, color, ok := strings.Cut(match, " ")
			if !ok {
				panic("invalid input")
			}
			...
			colorByCount[color] = max(colorByCount[color], n)
		}

		var power = 1
		for _, v := range colorByCount {
			power *= v
		}
...
var part1 = `Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green`

var part2 = `Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green`

var input = `Game 1: 3 blue, 7 green, 10 red; 4 green, 4 red; 1 green, 7 blue, 5 red; 8 blue, 10 red; 7 blue, 19 red, 1 green
